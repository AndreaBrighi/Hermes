...
<center>
<img src="img/scrum_planning.PNG" style="width: 90%;"/>
</center>
Come possiamo vedere dall'immagine sopra, la metodologia SCRUM permette poi di aggiungere in corso d'opera nuove user story, necessario una volta terminata la prima release e quindi in vista di una nuova fase di planning per la release successiva, in maniera iterativa.
...
Si noti che si è scelto di utilizzare la sequenza numerica di Fibonacci per definire la scala di possibili valori da selezionare, ovvero le carte da scegliere per ogni round.
<img src="img/poker_cards.PNG"/>
Chiaramente il voto personale deve essere influenzato solo dalla propria esperienza e dal livello di conoscenza del dominio.
